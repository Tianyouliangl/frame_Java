...
import com.test.project.widgets.BaseNetLayout;
import com.test.project.widgets.dialog.LoadingDialog;
...
public abstract class BaseMvpActivity<P extends IPresenterContract> extends MvpActivity<P> implements NetChangeListener {
    ...
    private BaseNetLayout net_view;
    ...
    public void initView() {
        ...
        net_view = findViewById(R.id.base_net);
